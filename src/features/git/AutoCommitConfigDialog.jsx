    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[440px]" onKeyDown={handleKeyDown}>
        ...
        <div className="space-y-4 py-2">
          {showSuccess && (
            <div className="flex items-center gap-2 text-primary bg-primary/10 border border-primary/30 rounded-none px-3 py-2">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full h-24 text-sm font-mono bg-background border border-border rounded-none p-2 resize-none focus:outline-none focus:ring-1 focus:ring-ring"
            />
          </div>
        </div>
